...
void showDialogEditBanner(context,BannerModel bannerDetails) {
  showDialog(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (isFirebaseuploading == false) {
                              if (bannerDetails.image.isEmpty) {
                                ...
                                FirebaseFirestore.instance
                                    .collection("banner")
                                    .doc(bannerDetails.bannerID)
                                    .update(
                                  {
                                    "image":image!=null? url:bannerDetails.image,
