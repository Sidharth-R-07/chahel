...
class BannerProductFrame extends StatefulWidget {
  const BannerProductFrame({super.key,required this.productDetails,required this.remove,});
  ...
  @override
  State<BannerProductFrame> createState() => _BannerProductFrameState();
}

class _BannerProductFrameState extends State<BannerProductFrame> {
